...
// Print arrivalTimeQueue program information
void ComputerSystem_PrintArrivalTimeQueue(){ 
  ...
  if (numberOfProgramsInArrivalTimeQueue>0) {
	for (i=0; i< numberOfProgramsInArrivalTimeQueue; i++) {
	  ...
	  ComputerSystem_DebugMessage(NO_TIMED_MESSAGE,59,LONGTERMSCHEDULE,programList[arrivalTimeQueue[i].info]->executableName,
